<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'RR_subscriber2_widget');
	function RR_subscriber2_widget() {
		register_widget('RR_subscriber2_widget');
	}
	
	
	class RR_Subscriber2_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('RR_subscriber2_widget',esc_html__('Harry Footer Subscriber 2','tocore'),array(
