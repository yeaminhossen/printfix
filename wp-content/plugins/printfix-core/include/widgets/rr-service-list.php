<?php 
Class RR_Services_List_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('rr-services-list', 'RR Services List', array(
			'description'	=> 'RR Services List'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('RR_Services_List_Widget');
});