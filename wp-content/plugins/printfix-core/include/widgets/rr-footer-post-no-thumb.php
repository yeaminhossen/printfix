<?php 
Class RR_Latest_Post_Footer_No_Thumb extends WP_Widget{

	public function __construct(){
		parent::__construct('RR-latest-posts-footer-no-thumb', 'Printfix Footer Posts No Thumb', array(
			'description'	=> 'Latest Post Widget by Printfix'
		));
	}
...
<div class="RR-footer-widget-content">
    ...
    <?php 
		...
		?>
    <div class="RR-footer-widget-item">
        <h4 class="RR-footer-widget-item-title"> <a
...
add_action('widgets_init', function(){
	register_widget('RR_Latest_Post_Footer_No_Thumb');
});