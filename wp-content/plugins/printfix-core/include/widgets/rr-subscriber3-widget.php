<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'RR_subscriber3_widget');
	function RR_subscriber3_widget() {
		register_widget('RR_subscriber3_widget');
	}
	
	
	class RR_Subscriber3_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('RR_subscriber3_widget',esc_html__('Harry Footer Subscriber 3','tocore'),array(
		...
		?>
							...
							<div class="footer__subscribe-8">
								...
								<div class="footer__social mt-25 RR-footer-social-orange">
