<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'RR_subscriber_widget');
	function RR_subscriber_widget() {
		register_widget('RR_subscriber_widget');
	}
	
	
	class RR_Subscriber_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('RR_subscriber_widget',esc_html__('Harry Footer Subscriber','tocore'),array(
