<?php
	...
	class bdevs_subscriber2_widget  extends WP_Widget{
		...
		?>
				...
				<div class="rr-footer-subscribe-area-two position-relative pt-100">
					<div class="container">
						<div class="rr-footer-subscribe-bg-two theme-yellow-bg pt-30 pb-20 z-index pl-60 pr-60">
							<div class="row align-items-center">
								<div class="col-xl-5 col-lg-4">
									<?php if( !empty($instance['title']) ): ?>
									<div class="rr-footer-subscribe">
										<h3 class="rr-footer-subscribe-title"><?php echo apply_filters( 'widget_title', $instance['title'] ); ?></h3>
									</div>
									<?php endif; ?>
								</div>
								<?php if( !empty($mailchimp_shortcode) ): ?>
								<div class="col-xl-7 col-lg-8">
									<div class="rr-footer-subscribe-form rr-footer-subscribe-form-2">
