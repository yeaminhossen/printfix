<?php 
Class RR_Posts_Footer_IMG_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('rr-latest-posts-footer-img', 'RR Footer Posts Image', array(
			'description'	=> 'Latest Post Widget by RR'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('RR_Posts_Footer_IMG_Widget');
});