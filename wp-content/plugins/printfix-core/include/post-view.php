...
function harry_blog_single_social(){
 ...
 ?>    
    <div class="postbox__share text-xl-end">
        ...
        <a href="htRRs://www.linkedin.com/shareArticle?mini=true&url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-linkedin rr-linkedin"></i></a>
        <a href="htRRs://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url($post_url);?>" target="_blank""><i class="fab fa-facebook rr-facebook" ></i></a>
        <a href="htRRs://twitter.com/share?url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-twitter rr-twitter"></i></a>
    </div>
   <?php return false;
}
...
function harry_product_single_social(){
 ...
 ?>    
    <div class="product__details-share">
        <span><?php echo esc_html__('Share On:', 'harry');?></span>
        <a href="htRRs://www.linkedin.com/shareArticle?mini=true&url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-linkedin-in rr-linkedin"></i></a>
        <a href="htRRs://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url($post_url);?>" target="_blank""><i class="fab fa-facebook-f rr-facebook" ></i></a>
        <a href="htRRs://twitter.com/share?url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-twitter rr-twitter"></i></a>
    </div>
   <?php return false;
}
