!function($, $ele, $i) {
    window.liteTranslated = function (e, t) {
        return elementorCommon.translate(e, null, t, rr-coreEditor.i18n)
    };
    ...
    $app.Views.EmptyTemplateCollection = Marionette.ItemView.extend({
        ...
        template: "#rr-core-liteTemplateLibrary_empty",
        ui: {
    ...
    $app.Views.Loading = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_loading",
        id: "liteTemplateLibrary_loading"
    }), 
    $app.Views.Logo = Marionette.ItemView.extend({
        template: "#rr-core-harry-template-library-header-logo",
    ...
    $app.Views.BackButton = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_header-back",
    ...
    $app.Views.Menu = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_header-menu",
    ...
    $app.Views.ResponsiveMenu = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_header-menu-responsive",
    ...
    $app.Views.Actions = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_header-actions",
    ...
    $app.Views.InsertWrapper = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_header-insert",
    ...
    $app.Views.Preview = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_preview",
    ...
    $app.Views.TemplateCollection = Marionette.CompositeView.extend({
        template: "#rr-core-liteTemplateLibrary_templates",
    ...
    $app.Views.Template = Marionette.ItemView.extend({
        template: "#rr-core-liteTemplateLibrary_template",
    ...
    $app.Modal = elementorModules.common.views.modal.Layout.extend({
        ...
        getTemplateActionButton: function(e) {
            var t = e.isPro && !rr-coreEditor.hasPro ? "pro-button" : "insert-button";
            return viewId = "#rr-core-liteTemplateLibrary_" + t, template = Marionette.TemplateCache.get(viewId), Marionette.Renderer.render(template)
        },
        showLogo: function(e) {
    ...
    $app.Manager = function() {
        ...
        function addButton() {
            ...
            }), $sl.find(".rr_templates_add_button").length || $sl.find(DROIT_FIND_SELECTOR).before($rr-corePpenLibraryButton)
        }

        function initAddButton($el) {
            var $t = $el.find(DROIT_FIND_SELECTOR);
            $t.length && !$el.find(".rr_templates_add_button").length && $t.before($rr-corePpenLibraryButton), $el.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", addButton)
        }

        function onChanges(t, i) {
            i.addClass("elementor-active").siblings().removeClass("elementor-active");
            var a = $RRResponsiveMap[t] || $RRResponsiveMap.desktop;
        ...
        function onEditorLoaded() {
            var $el = window.elementor.$previewContents,
                ...
                $el.on("click.onAddTemplateButton", ".rr_templates_add_button", $this.showModal.bind($this)), this.channels.tabs.on("change:device", onChanges)
        }
        ...
        $rr-corePpenLibraryButton = '<div class="elementor-add-section-area-button rr_templates_add_button"> <img src="'+rr-coreEditor.templateLogo+'" /> </div>', 
        $RRResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
        ...
        this.init = function() {
            $this.setFilter("type", rr-coreEditor.default_tab, !0), $ele.on("preview:loaded", onEditorLoaded.bind(this))
        }, 
        this.getTabs = function() {
            var e = this.getFilter("type");
            return tabs = JSON.parse(rr-coreEditor.tab_style)
        ...
        this.requestLibraryData = function(e) {
            ...
            e.forceSync && (t.data.sync = !0), elementorCommon.ajax.addRequest("get_rr-core_library_data", t)
        }, 
        this.requestTemplateData = function(e, t) {
            ...
            t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_rr-core_template_data", i)
        }, 
...
}(jQuery, window.elementor, window.rr-core || {});
